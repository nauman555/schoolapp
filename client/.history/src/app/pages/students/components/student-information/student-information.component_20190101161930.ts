...
export class StudentInformationComponent implements OnInit {
  ...
  loadData() {
    ...
    this.singleStdInfo = this._StudentsInfoService.Single_std_data
    this.singleParentInfo = this._StudentsInfoService.Single_parent_data
  }
