...
router.post('/add-teacher',(req , res ,next)=>{
    ...
    teacher_id`, `teacher_name`, `teacher_qualification`, `teacher_designation`, `gender`, `dob`, `phone_num`, `email`, `password`, `added_date`, `updated_date`, `status`) VALUES (NULL, 'ali', 'BA', 'Teacher', 'Male', '20-11-1995', '031298585', 'ali@ali', '123456', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '1');
    let teacherDetails = {}
    //inserting into db
