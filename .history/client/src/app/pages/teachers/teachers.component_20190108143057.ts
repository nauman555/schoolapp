...
export class TeachersComponent implements OnInit {
  ...
  teacher_name 
  teacher_qual  = singleTeacher.teacher_qual;
  teacher_desig = singleTeacher.teacher_desig;
  password      = singleTeacher.password;
  gender        = singleTeacher.gender;
  dob           = singleTeacher.dob;
  phone_num     = singleTeacher.phone_num;
  ...
  getSingleTeacherData(id){
    this._teachersDataService.getSingleTeacherF(id)
      .subscribe(result=>  {
        ...
        this.singleTeacher = this.singleTeacherData[0];
         
        let teacher_name  = singleTeacher.teacher_name;
        let teacher_qual  = singleTeacher.teacher_qual;
        let teacher_desig = singleTeacher.teacher_desig;
        let password      = singleTeacher.password;
        let gender        = singleTeacher.gender;
        let dob           = singleTeacher.dob;
        let phone_num     = singleTeacher.phone_num;
        let email         = singleTeacher.email;
        let address       = singleTeacher.address;  
