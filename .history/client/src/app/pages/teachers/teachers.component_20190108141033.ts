  ...
  getSingleTeacherData(id){
    ...
    this._teachersDataService.getSingleTeacherF(id)
      .subscribe(result=>  {
        ...
        let password      = singleTeacher.teacher_id;
        let gender        = singleTeacher.teacher_id;
        let dob           = singleTeacher.teacher_id;
        let phone_num     = singleTeacher.teacher_id;
        let email         = singleTeacher.teacher_id;
        let address       = singleTeacher.teacher_id;
