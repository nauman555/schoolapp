...
export class TeachersComponent implements OnInit {
  ...
  // ******************* OnSubmit add teacher event handler function ******************/
  ...
  // ******************* OnSubmit Update teacher event handler function ******************/
  ...
  this._teachersDataService.updateTeacherF(updateTeacherData)
  .subscribe(result => {
    this.teachersDataList.push(result);
    // load data from db after add
    this._teachersDataService.getTeachersF()
  ...
  // show success notification
  this.updateSuccessNotification = 1;
  this.FadeOutToaster();
