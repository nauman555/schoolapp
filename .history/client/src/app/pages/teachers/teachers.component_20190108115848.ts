...
export class TeachersComponent implements OnInit {
  ...
  teachersDataList: any[] = [];  //array to store teachers data fetching from DB
  singleTeacherData: any[] = []; // array to store single teacher data 
  private pageSize = 10;
  ...
  getSignleTeacherData(id){
    this._teachersDataService.getSingleTeacherF(id)
      .subscribe(result=> this.singleTeacherData = result.data);
