...
import {TeachersDataScheme} from './../../../teachers/teachers.service';  // import teachers data service to use teachers data 
...
export class ManageClassComponent implements OnInit {
  ...
  constructor(
    ...
    private _teachersDataScheme: TeachersDataScheme
