  ...
  getSingleSectionData(section_id , class_id){
    ...
    this._sectionDataService.getSingleSectionF(section_id,class_id)
      .subscribe(result =>{
        ...
        this.section_id   = singleSectionList.section_id;
        this.section_name = singleSectionList.section_name;
        this.class_id     = singleSectionList.class_id;
        this.class_name   = singleSectionList.class_name;
        this.teacher_id   = singleSectionList.teacher_id;
        this.teacher_name = singleSectionList.teacher_name;
      });
